...
runner.train(
    ...
    log_iters=LOG_ITERS, 
    save_dir=SAVE_DIR,
    save_name=f'{MODEL_TYPE}_best_model.pickle' 
)
...
with open(os.path.join(SAVE_DIR, f'{MODEL_TYPE}_history.pickle'), 'wb') as f:
    pickle.dump(history, f)
print(f"Training history saved to {os.path.join(SAVE_DIR, f'{MODEL_TYPE}_history.pickle')}")
